...
# A target like 'obj/main.o' will depend on 'main.cpp'.
# Header dependencies are optional here; add explicit dependencies
# or use automatic dependency generation if needed.
